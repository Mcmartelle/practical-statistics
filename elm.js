...
var $author$project$Main$chanceToSamplesFloat = F3(
	function (chance, numerator, denominator) {
		var lnStat = A2($elm$core$Basics$logBase, $elm$core$Basics$e, 1 - (numerator / denominator));
		var lnChance = A2($elm$core$Basics$logBase, $elm$core$Basics$e, 1 - chance);
		return lnChance / lnStat;
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Main$chanceToSamples = F3(
	function (chance, numerator, denominator) {
		return $elm$core$String$fromFloat(
			A3($author$project$Main$chanceToSamplesFloat, chance, numerator, denominator));
	});
var $author$project$Main$isWholeNumber = function (num) {
	return !(num - $elm$core$Basics$floor(num));
};
var $author$project$Main$chanceToSamplesExact = F3(
	function (chance, numerator, denominator) {
		return $author$project$Main$isWholeNumber(
			A3($author$project$Main$chanceToSamplesFloat, chance, numerator, denominator));
	});
var $author$project$Main$chanceToSamplesRoundUp = F3(
	function (chance, numerator, denominator) {
...
var $author$project$Main$percentToTitle = function (val) {
	return $elm$core$String$fromFloat(val) + '%';
};
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$Main$samplesToChanceFloat = F3(
	function (samples, numerator, denominator) {
		var lnStat = A2($elm$core$Basics$logBase, $elm$core$Basics$e, 1 - (numerator / denominator));
		return (1 - A2($elm$core$Basics$pow, $elm$core$Basics$e, samples * lnStat)) * 100;
	});
var $author$project$Main$samplesToChance = F3(
	function (samples, numerator, denominator) {
		return $elm$core$String$fromFloat(
			A3($author$project$Main$samplesToChanceFloat, samples, numerator, denominator));
	});
var $author$project$Main$samplesToChanceExact = F3(
	function (samples, numerator, denominator) {
		return $author$project$Main$isWholeNumber(
			A3($author$project$Main$samplesToChanceFloat, samples, numerator, denominator));
	});
var $elm$core$Basics$round = _Basics_round;
var $author$project$Main$samplesToChanceRounded = F3(
	function (samples, numerator, denominator) {
		return $elm$core$String$fromInt(
			$elm$core$Basics$round(
				A3($author$project$Main$samplesToChanceFloat, samples, numerator, denominator)));
	});
var $author$project$Main$samplesToTitle = function (val) {
	return $elm$core$String$fromFloat(val) + ' samples';
};
var $author$project$Main$init = function (_v0) {
	var initialSamples = 10;
	var sCustomSamples = initialSamples;
	var initialPercent = 50;
	var oCustomChance = initialPercent / 100;
	var initialNumerator = 1;
	var initialDenominator = 100;
	var initStatPercent = $elm$core$String$fromFloat((initialNumerator / initialDenominator) * 100);
	var initSCustomChanceRounded = A3($author$project$Main$samplesToChanceRounded, sCustomSamples, initialNumerator, initialDenominator);
	var initSCustomChanceExact = A3($author$project$Main$samplesToChanceExact, sCustomSamples, initialNumerator, initialDenominator);
	var initSCustomChance = A3($author$project$Main$samplesToChance, sCustomSamples, initialNumerator, initialDenominator);
	var initOCustomSamplesRoundUp = A3($author$project$Main$chanceToSamplesRoundUp, oCustomChance, initialNumerator, initialDenominator);
	var initOCustomSamplesExact = A3($author$project$Main$chanceToSamplesExact, oCustomChance, initialNumerator, initialDenominator);
...
var $author$project$Main$Bad = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$calcOCustom = F4(
	function (oCus, chance, nume, deno) {
...
var $author$project$Main$calcSCustom = F4(
	function (sCus, samples, nume, deno) {
		var rounded = A3($author$project$Main$samplesToChanceRounded, samples, nume, deno);
		var exact = A3($author$project$Main$samplesToChanceExact, samples, nume, deno);
		var chance = A3($author$project$Main$samplesToChance, samples, nume, deno);
...
var $author$project$Main$getDenominatorError = F2(
	function (deno, nume) {
		var _v0 = $elm$core$String$toFloat(deno);
		if (!_v0.$) {
			var denom = _v0.a;
			return (denom <= 0) ? 3 : ((_Utils_cmp(denom, nume) < 1) ? 3 : 0);
		} else {
			return (!$elm$core$String$length(deno)) ? 1 : 4;
		}
	});
var $author$project$Main$AboveAllowedRange = 2;
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Main$getNumeratorError = F2(
	function (nume, deno) {
		var _v0 = $elm$core$String$toFloat(nume);
		if (!_v0.$) {
			var numer = _v0.a;
			return (numer <= 0) ? 3 : ((_Utils_cmp(numer, deno) > -1) ? 2 : 0);
		} else {
			return (!$elm$core$String$length(nume)) ? 1 : 4;
		}
	});
var $author$project$Main$getPercentError = function (newNumber) {
	var _v0 = $elm$core$String$toFloat(newNumber);
	if (!_v0.$) {
		var perc = _v0.a;
		return (perc <= 0) ? 3 : (((perc === 100) && ($elm$core$String$length(newNumber) > 5)) ? 2 : ((perc >= 100) ? 2 : 0));
	} else {
		return (!$elm$core$String$length(newNumber)) ? 1 : 4;
	}
};
var $author$project$Main$getSamplesError = function (newNumber) {
	var _v0 = $elm$core$String$toFloat(newNumber);
	if (!_v0.$) {
		var samp = _v0.a;
		return (samp <= 0) ? 3 : 0;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var newNumber = msg.a;
				var percentVal = function () {
					var _v3 = $elm$core$String$toFloat(newNumber);
					if (!_v3.$) {
						var num = _v3.a;
						return num;
					} else {
			...
			default:
				var newNumber = msg.a;
				var samplesVal = function () {
					var _v4 = $elm$core$String$toFloat(newNumber);
					if (!_v4.$) {
						var num = _v4.a;
						return num;
					} else {
...
var $author$project$Main$ChangeDenominator = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$ChangeNumerator = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$ChangePercent = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$ChangeSamples = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$inputEmptyMessage = 'Input is empty';
var $author$project$Main$notANumberMessage = 'Must be a number';
var $author$project$Main$denominatorErrorToMessage = function (err) {
	switch (err) {
		case 0:
			return '';
		case 1:
			return $author$project$Main$inputEmptyMessage;
		case 2:
			return '';
		case 3:
			return 'Must be greater than zero and greater than the first input number';
		default:
			return $author$project$Main$notANumberMessage;
	}
};
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$errColorCss = function (err) {
	switch (err) {
		case 0:
			return 'all-good';
		case 1:
...
var $author$project$Main$inputErrGood = function (err) {
	if (!err) {
		return true;
	} else {
		return false;
...
var $author$project$Main$fixedChanceErr = F3(
	function (nume, deno, perc) {
		return $author$project$Main$inputErrGood(nume) && ($author$project$Main$inputErrGood(deno) && $author$project$Main$inputErrGood(perc));
	});
var $author$project$Main$inputNotApplicable = 'Input is not applicable...';
		...
		if (!_v0.$) {
			if (inputsGood) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('item output-item')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Chance of Occurrence ➜ Sample Size')
								])),
							A2(
							$elm$html$Html$p,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('big-num')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('explainer')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('exact')
								]),
							_List_fromArray(
								[
...
var $author$project$Main$fixedSamplesErr = F3(
	function (nume, deno, samp) {
		return $author$project$Main$inputErrGood(nume) && ($author$project$Main$inputErrGood(deno) && $author$project$Main$inputErrGood(samp));
	});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Sample Size ➜ Chance of Occurrence')
								])),
							A2(
							$elm$html$Html$p,
							_List_fromArray(
...
var $author$project$Main$numeratorErrorToMessage = function (err) {
	switch (err) {
		case 0:
			return '';
		case 1:
			return $author$project$Main$inputEmptyMessage;
		case 2:
			return 'Must be less than the second number to make a fraction less than 1';
		case 3:
...
var $author$project$Main$percentErrorToMessage = function (err) {
	switch (err) {
		case 0:
			return '';
		case 1:
...
var $author$project$Main$samplesErrorToMessage = function (err) {
	switch (err) {
		case 0:
			return '';
		case 1:
...
var $author$project$Main$superAllGood = F4(
	function (nume, deno, perc, samp) {
		return $author$project$Main$inputErrGood(nume) && ($author$project$Main$inputErrGood(deno) && ($author$project$Main$inputErrGood(perc) && $author$project$Main$inputErrGood(samp)));
	});
var $author$project$Main$superAllGoodCss = F4(
	function (nume, deno, perc, samp) {
		return A4($author$project$Main$superAllGood, nume, deno, perc, samp) ? 'all-good' : 'oh-no';
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Practical Statistics')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('sub-item')
									]),
								_List_fromArray(
									[
										A2(
